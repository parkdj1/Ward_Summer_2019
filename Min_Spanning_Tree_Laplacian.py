...
Minimally spanning tree as the laplacian matrix
...
def main():
    ...
    laplacian = find_normalized_laplacian_matrix(distances,  degree_bounds,norm_data.shape[0], index_mapping)
...
def find_normalized_laplacian_matrix(distances, degree_bounds, num_rows, index_mapping):
