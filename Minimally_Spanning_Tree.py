...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul  8 12:39:10 2019
...
def main():
    ...
    min_sp_tree = build_min_spanning_tree(copy(mapped_distances), degree_bounds, norm_data.shape[0])
...
def build_min_spanning_tree(distances, degree_bounds, num_rows):
...
#    return min_spanning_tree
    ...
    while  np.amin(components) == 0:
        dist, index = distances[0] # i,j is the location in the Laplacian corresponding to location in distances
        i,j = index
