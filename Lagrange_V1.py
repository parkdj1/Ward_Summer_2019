...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun 28 12:33:58 2019
...
def get_predictions(train_indices, test_indices, data_class, distances, degree_bounds, index_mapping,laplacian_matrix):

    num_rows = data_class.shape[0]
    ...
    A[:num_rows, :num_rows] = 2 * np.dot(laplacian_matrix, laplacian_matrix)
    ...
    for i in range(num_classes):
        # build matrix b
        b[num_rows:] = data_class[train_indices.astype(int),:][:,i]
